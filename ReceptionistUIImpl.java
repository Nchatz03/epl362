...
public class ReceptionistUIImpl implements ReceptionistUI {
	...
	public boolean insertDropIN(int ClientID, String Date, int LawyerID, int BranchID) {
		...
		try {
			...
			/*
			 * if(result.next()){ if(result.getBoolean("DEACTIVE")==true){ return false;
			 * 
			 * } } else return false;
			 */
		...
		try {
			...
			while (result.next()) {
				...
				Q.add(new Object[] { result.getString("ID"), result.getString("Name"), result.getString("Surname"),
						...
						result.getString("Address"), result.getString("NeedsUpdate"),
						 result.getString("Status"), result.getString("ChangedRecord") });
	...
	public boolean insertLegalOpinion(String Rec_LegalOp) { // tha xrisimopoieitai gia na valoume recommendation kai legal Strategy
...
public boolean insertRecommendation(String Rec) { // tha xrisimopoieitai gia na valoume recommendation kai legal Strategy
